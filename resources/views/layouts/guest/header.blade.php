<div class="nav-container ">
    <div class="bar bar--sm bar--mobile-sticky visible-xs bar--absolute" data-scroll-class='10vh:pos-fixed'>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 order-lg-1">
                    <div class="bar__module">
                        <ul class="menu-horizontal text-left">
                            ...
                            <li>
                                <a class="inner-link" href="#packages">Packages</a>
                            </li>
                            <li>
                                <a class="inner-link" href="#gallery">Gallery</a>
                            </li>
                            <li>
                                <a class="inner-link" href="#contact">Contact us</a>
                            </li>
                        </ul>
                    </div>
                    <!--end module-->
